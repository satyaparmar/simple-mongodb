...
{
    [TestClass]
    public class UpdateDocumentsDbTests
        : DbTestBase
    {
        [TestMethod]
        public void UpdateSinglePerson_ManyExists_OneIsUpdated()
        {
            ...
            Assert.AreEqual(1, GetDocumentCount(new { Name = "Daniel3" }, Constants.Commands.PersonsFullCollectionName));
        }
        ...
        public void UpdateManyPersons_UsingJsonWhereManyExists_AllAreUpdated()
        {
            ...
            Assert.AreEqual(2, GetDocumentCount(new { Name = "The Daniel" }, Constants.Commands.PersonsFullCollectionName));
        }
        ...
        public void UpdateManyPersons_UsingDocumentWhereManyExists_NoneIsUpdated()
        {
            ...
            Assert.AreEqual(0, GetDocumentCount(new { Name = "The Daniel" }, Constants.Commands.PersonsFullCollectionName));
        }
    }
}